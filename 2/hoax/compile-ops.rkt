    ...
    ['vector-append
     ...
     (let ([loop (gensym)]
          ...
          (seq (assert-vector rax)
               ...
               (Push rax)               ;push second vector
               (Cmp r8 0)               ;if r8 is blank
               (Je end)
               (Pop rax)                ;pop that value
               (Push r8)                ;push first vector
               (Cmp rax 0)              ;if rax is blank
               (Je end)
               (Pop r8)                 ;pop first vector

               (Push rax)               ;push the second vector
               (Push rbx)               ;save addy
               (Mov r9 (Offset rax 0))  ;length 2
               (Add r9 (Offset r8 0))   ;length 1
               (Mov (Offset rbx 0) r9)  ;new length into memory
               (Mov r9 (Offset r8 0))   ;get length 1 into r9
               (Add rbx 8)              ;start at 0th
               (Add r8 8)               ;copy from 0th
               ...
               (Pop rax)                ;pop new addy
               (Pop r8)                 ;get second vec
               (Push rax)               ;push it back
               (Mov r9 (Offset r8 0))   ;save length
               (Add r8 8)               ;get values
               (Push 1)                 ;push i
               (Jmp loop)
